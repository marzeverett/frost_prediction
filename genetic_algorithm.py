...
#Give it a dataframe - ALL the data it needs in one huge thingamabob 
#Also give it the data definitions 
#1 or 0
#Discrete 
#Continuous 

#From this, it should figure out how to use 

#CAN you do this is ONLY a MONTH??? 
#Maybe - got a prototype working in 2 days...
#Include parameters 

#Start with continuous. 

#Type will depend on bool

#Upper and lower bound should probably be inclusive!!! Important 


#Dominated rules - kill the rest. Another facet!! 

#HOw the FRESH are we going to optimize this???? 

#AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA


#Try to work only 8 hours on Sunday and Monday (maybe just Monday -- hmm. )

#Need to get analysis for VitalDB up and running as soon as possible.

#Negative Units offset. - How going to do with the support lift confidence, etc? 

#That's going to require just slightly more thought -- put up a reminder on what each metric is, please 

#Could also think of "elite experiment" set for Jornada. 
